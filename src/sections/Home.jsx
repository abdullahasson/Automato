    ...
    return (
        <section id="Home" className="h-screen flex justify-center items-center relative">
            <div className="text-center text-[white] h-full w-[590px] z-[100] max-[500px]:flex flex-col justify-center items-center">
                ...
                <p className="text-[2rem] leading-[1.6] mt-[1.1rem] mb-10 max-[500px]:text-[18px] max-[500px]:my-[20px] max-[482px]:px-[28px]">
                ...
                <Button href="#Contact"  className="w-auto">التواصل معنا</Button>
                <div className="photo">
